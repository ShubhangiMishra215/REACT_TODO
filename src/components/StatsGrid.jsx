...
const StatsGrid = ({completeTodos, activeTodos, totalTodos}) => {
  
  return (
    <>
      <div className='grid grid-cols-3 gap-3 mb-4'>
        <div className='bg-linear-to-br from-violet-500/20 to-purple-500/20 rounded-2xl
        border border-violet-400/30 p-4 hover:scale-105 transition-transform duration-300
        cursor-pointer'>
          <div className='backdrop-blur-2xl flex items-center gap-2 mb-1'>
        ...
        border border-emerald-400/30 p-4 hover:scale-105 transition-transform duration-300
        cursor-pointer'>
          <div className='flex items-center gap-2 mb-1'>
            <CheckCircle size={16} className='text-emerald-400'/>
            <span className='text-emerald-300 text-xs font-semibold'>Done</span>
          </div>
          <div className='text-2xl font-black text-white'>{completeTodos}</div>
        </div>
